...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func enterApp() {
        ...
        let mainViewNavCtrl = STORY.instantiateViewController(withIdentifier: "tabBarCtrlNavCtrl") as? UINavigationController
        drawerVC = LDrawerViewController(center: mainViewNavCtrl, leftController: settingNavCtrl)
        let drawerNavCtrl = UINavigationController(rootViewController: drawerVC!)
        drawerNavCtrl.isNavigationBarHidden = true
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "OmnipotentApp", withExtension: "momd")!
